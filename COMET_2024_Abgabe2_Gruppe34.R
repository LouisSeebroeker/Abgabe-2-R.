...
#einlesen der Daten
alle_daten <- read.csv(file=
        "Capital_bikeshare_data_2022_with_NAs (2).csv", #Pfad zu den Daten
        sep=",",                        #Komma als Trennzeichen
        dec=".",                        #Punkt als Dezimaltrennzeichen
        header=TRUE)                    #erste Zeile als Überschrift festlegen
...
#Es fällt auf, dass es negative Windgeschwindigkeiten gibt, da dies unlogisch
#ist werden die Werte entfernt.
summary(unsere_station)
